...
20120703   bcb   Changed win32 to !UNIX, added prototypes.
20120710   bcb   Copy mysql includes or amake "location of MySQL in short form"/include, no hard code!
20120722   mvh   use "mysql.h" instead of <mysql.h>
*/
...
#ifndef UNIX			   /* load mysql dynamically */
extern "C"
{
//#include "C:\mysql-5.0.22-win32\include\mysql.h"//bcb I have 5.5!
#include "mysql.h"
...
#ifndef UNIX			   /* load postgres dynamically */
extern "C"
{
#define PGCALL 
