...
20120703        bcb     changed WINDOWS to !UNIX
20130226        bcb     changed IMPLEMENTATION_VERSION_STRING to 1.4.18/WIN32
*/
...
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.18/WIN32"
#else
#ifdef	ULTRIXMIPS
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.18/UMIPS"
#else
#ifdef	SOLARIS
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.18/SL5"
#else
#ifdef	MAC
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.18/MAC"
#else
#ifdef	SUNOSSPARC
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.18/SUNOS"
#else
#ifdef	DARWIN
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.18/OSX"
#else
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.18/OTHER"
#endif
#endif
#endif
#endif
