...
20120703    bcb    Moved SwapBigEndianData to here from trnsyn
20130331    bcb    Fixed strlen warnings with strn32u()
 */
...
{
    VR      *vr;
    UINT32    slen;//bcb warn
    INT     rc = 1;
    
    slen = strnlen32u(str);// Remove the end
    vr = this->GetVR( g, e );
    if(!vr)
    {
